...
def invalidate_import_log_in_progress_cache(sender, instance, created, **kwargs):
    """
    ...
    if instance.status != ImportLogStatusEnum.IN_PROGRESS.value:
        cache_key = CacheKeyEnum.IMPORT_LOG_IN_PROGRESS.value.format(workspace_id=instance.workspace_id, attribute_type=instance.attribute_type)
